...
from the previous tasks, into a file named “softuni-backup.sql”. 
Drop your database from Heidi or MySQL Workbench. 
Then restore the database from the created backup file by using mysql  command line.
*/
